        ...
        internal protected override bool TryParse(JsonReader reader)
        {
            ...
            switch (reader.Path)
            {
                case "PrecipitationType":
                    PrecipitationType = reader.AsEnum(PrecipitationType);
                    break;
                case "PrecipitationDensity":
                    Density = reader.AsFloat(Density);
                    break;
                ...
                case "PrecipitationProbability":
                    Probability = reader.AsFloat(Probability);
                    break;
                case "PrecipitationSpread":
                    Spread = reader.AsFloat(Spread);
                    break;
                ...
                case "PrecipitationVisibilityAtMaxDensity":
                    VisibilityAtMaxDensity = reader.AsFloat(VisibilityAtMaxDensity);
                    break;
                case "OvercastPrecipitationStart":
                    OvercastPrecipitationStart = reader.AsFloat(OvercastPrecipitationStart);
                    break;
                case "OvercastBuildUp":
                    OvercastBuildUp = reader.AsFloat(OvercastBuildUp);
                    break;
                case "PrecipitationStartPhase":
                    PrecipitationStartPhase = reader.AsFloat(PrecipitationStartPhase);
                    break;
                case "OvercastDispersion":
                    OvercastDispersion = reader.AsFloat(OvercastDispersion);
                    break;
                case "PrecipitationEndPhase":
                    PrecipitationEndPhase = reader.AsFloat(PrecipitationEndPhase);
                    break;
