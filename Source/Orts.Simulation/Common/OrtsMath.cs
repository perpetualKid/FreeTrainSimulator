...
namespace Orts.Common
{
    public static class OrtsMath
    {
        ...
        //
        public static void MatrixToAngles(ref Matrix m, out float heading, out float attitude, out float bank)
        ...
        public static float MatrixToYAngle(ref Matrix m)
        {    // Assuming the angles are in radians.
        ...
        public static float LineSegmentDistanceSq(in Vector3 pt, in Vector3 end1, in Vector3 end2)
        {
