...
namespace Orts.Simulation.AIs
{
    public class AI
    {
        ...
        public AITrain CreateAITrainDetail(Services sd, ServiceTraffics trfDef, ServiceFile srvFile, bool isTimetableMode, bool isInitialPlayerTrain)
        {
            ...
            // 
            AIPath aiPath = new AIPath(Simulator.TrackDatabase, pathFileName, isTimetableMode);
            // End patch
            ...
            train.RearTDBTraveller = new Traveller(Simulator.TrackDatabase.TrackDB.TrackNodes, aiPath); // create traveller
#if WITH_PATH_DEBUG
