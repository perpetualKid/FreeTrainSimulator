...
#pragma warning restore CA1002 // Do not expose generic lists
        ...
        public async ValueTask Restore(SimulatorSaveState saveState)
        {
            ...
            Trains = new TrainList(this);
            await Trains.RestoreCollectionCreateNewInstances(saveState.Trains, this).ConfigureAwait(false);
            AI ??= new AI(this);
            await AI.AITrains.RestoreCollectionCreateNewInstances(saveState.TimetableTrains, this).ConfigureAwait(false);
            await AI.StartList.RestoreCollectionCreateNewInstances(saveState.TimetableStartTrains, this).ConfigureAwait(false);
            StartReference.AddRange(AI.StartList.Select(t => t.Number));
            await AI.AutoGenTrains.RestoreCollectionCreateNewInstances(saveState.TimetableAutoGeneratedTrains, this).ConfigureAwait(false);
