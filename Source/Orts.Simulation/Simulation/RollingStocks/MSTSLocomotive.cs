    ...
    public partial class MSTSLocomotive : MSTSWagon
    {
        ...
        public override void Initialize()
        {
            ...
            if (DoesBrakeCutPower && (BrakeSystem is VacuumSinglePipe) && ( BrakeCutsPowerAtBrakePipePressurePSI == 0 || BrakeCutsPowerAtBrakePipePressurePSI > OneAtmospherePSI))
            {
                ...
                if (Simulator.Settings.VerboseConfigurationMessages)
                {
                    Trace.TraceInformation("BrakeCutsPowerAtBrakePipePressure appears out of limits, and has been set to value of {0} InHg", Pressure.Atmospheric.ToInHg(Pressure.Atmospheric.FromPSI(BrakeCutsPowerAtBrakePipePressurePSI)));
                }
            }
