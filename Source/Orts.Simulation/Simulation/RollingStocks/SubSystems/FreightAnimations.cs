        ...
        public FreightAnimations(STFReader stf, MSTSWagon wagon)
        {
            ...
            bool empty = true;
              stf.ParseBlock(new[] {
                ...
                new STFReader.TokenProcessor("emptywagonfrontalarea", ()=>{ EmptyORTSWagonFrontalAreaM2 = stf.ReadFloatBlock(STFReader.UNITS.AreaDefaultFT2, -1); }),
    ...
    public class FreightAnimationContinuous : FreightAnimation
    {
        ...
        public FreightAnimationContinuous(STFReader stf, MSTSWagon wagon)
        {
            ...
            stf.ParseBlock(new STFReader.TokenProcessor[] {
                ...
                new STFReader.TokenProcessor("fullwagonfrontalarea", ()=>{ FullORTSWagonFrontalAreaM2 = stf.ReadFloatBlock(STFReader.UNITS.AreaDefaultFT2, -1); }),
    ...
    public class FreightAnimationStatic : FreightAnimation
    {
        ...
        public FreightAnimationStatic(STFReader stf)
        {
            ...
            new STFReader.TokenProcessor("subtype", ()=>
                ...
                new STFReader.TokenProcessor("fullwagonfrontalarea", ()=>{ FullStaticORTSWagonFrontalAreaM2 = stf.ReadFloatBlock(STFReader.UNITS.AreaDefaultFT2, -1); }),
