...
namespace Orts.Settings
{
    ...
    public class InputSettings : SettingsBase
    {
        ...
        private static void InitializeCommands(UserCommandInput[] Commands)
        {
            ...
            Commands[(int)UserCommand.ControlCylinderCocks] = new UserCommandKeyInput(0x2E, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            ...
            Commands[(int)UserCommand.ControlDynamicBrakeDecrease] = new UserCommandKeyInput(0x33, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlDynamicBrakeIncrease] = new UserCommandKeyInput(0x34, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlEmergencyPushButton] = new UserCommandKeyInput(0x0E);
            Commands[(int)UserCommand.ControlEngineBrakeDecrease] = new UserCommandKeyInput(0x1A, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlEngineBrakeIncrease] = new UserCommandKeyInput(0x1B, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            ...
            Commands[(int)UserCommand.ControlFiring] = new UserCommandKeyInput(0x21, KeyModifiers.Control, KeyEventType.KeyDown | KeyEventType.KeyPressed);
            ...
            Commands[(int)UserCommand.ControlGearDown] = new UserCommandKeyInput(0x12, KeyModifiers.Shift, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlGearUp] = new UserCommandKeyInput(0x12, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            ...
            Commands[(int)UserCommand.ControlPantograph1] = new UserCommandKeyInput(0x19, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlPantograph2] = new UserCommandKeyInput(0x19, KeyModifiers.Shift, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlPantograph3] = new UserCommandKeyInput(0x19, KeyModifiers.Control, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlPantograph4] = new UserCommandKeyInput(0x19, KeyModifiers.Shift | KeyModifiers.Control, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            ...
            Commands[(int)UserCommand.ControlReverserBackward] = new UserCommandKeyInput(0x1F, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlReverserForward] = new UserCommandKeyInput(0x11, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlSander] = new UserCommandKeyInput(0x2D, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlSanderToggle] = new UserCommandKeyInput(0x2D, KeyModifiers.Shift, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlThrottleDecrease] = new UserCommandKeyInput(0x1E, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlThrottleIncrease] = new UserCommandKeyInput(0x20, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlThrottleZero] = new UserCommandKeyInput(0x1E, KeyModifiers.Control);
            Commands[(int)UserCommand.ControlTrainBrakeDecrease] = new UserCommandKeyInput(0x27, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            Commands[(int)UserCommand.ControlTrainBrakeIncrease] = new UserCommandKeyInput(0x28, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
            ...
            Commands[(int)UserCommand.GameAutopilotMode] = new UserCommandKeyInput(0x1E, KeyModifiers.Alt, KeyEventType.KeyPressed | KeyEventType.KeyDown | KeyEventType.KeyReleased);
