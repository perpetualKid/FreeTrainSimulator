...
namespace Orts.Settings
{
    ...
    public class InputSettings : SettingsBase
    {
        ...
        private static void InitializeCommands(UserCommandInput[] Commands)
        {
            ...
            Commands[(int)UserCommand.ControlReverserBackward] = new UserCommandKeyInput(0x1F);
            Commands[(int)UserCommand.ControlReverserForward] = new UserCommandKeyInput(0x11);
            ...
            Commands[(int)UserCommand.DebugPrecipitationLiquidityDecrease] = new UserCommandKeyInput(0x0C, KeyModifiers.Control);
            Commands[(int)UserCommand.DebugPrecipitationLiquidityIncrease] = new UserCommandKeyInput(0x0D, KeyModifiers.Control);
