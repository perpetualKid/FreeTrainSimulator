...
namespace ORTS
{
    static class Program
    {
        ...
        public static Debugging.PhysicsDebugForm PhysicsDebugForm;
        ...
        static void Start(UserSettings settings, string[] args)
        {
            ...
            PhysicsDebugForm = new PhysicsDebugForm(Simulator, Viewer);
            PhysicsDebugForm.Show();
            Viewer.PhysicsDebugFormEnabled = false;
