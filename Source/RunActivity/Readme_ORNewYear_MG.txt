Open Rails, Monogame version (unofficial) README - Release NewYear - Rev.22
May 21st, 2019
...
It has been derived from the official Open Rails revision X1.3.1-57-etc, by modifying anything needed to access the Monogame software.
...
- UPDATED: F5 HUD scrolling (by mbm_or)
...
- enhanced human dispatching for AI trains.
- removed bug in OR MG concerning display of ETCS gauge (by dennisat)
- NEW: removed OR-MG specific bug not displaying some icons in TrackViewer
- UPDATED: improved distance management in roadcar camera
- NEW: animation of bell
