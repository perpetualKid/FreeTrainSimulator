...
namespace Orts.Viewer3D
{
    public class LightViewer
    {
        ...
        bool UpdateState()
        {
			Debug.Assert(Viewer.PlayerTrain.LeadLocomotive == Viewer.PlayerLocomotive ||Viewer.PlayerTrain.TrainType == Train.TRAINTYPE.AI_PLAYERHOSTING || Viewer.PlayerTrain.TrainType == Train.TRAINTYPE.REMOTE, "PlayerTrain.LeadLocomotive must be PlayerLocomotive.");
