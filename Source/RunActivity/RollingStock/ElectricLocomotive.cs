...
namespace ORTS
{
    ...
    public class ElectricLocomotive: Locomotive
    {
        ...
        public ElectricLocomotive(WAGFile wagFile)
            : base(wagFile)
        {
        }
    ...
    class ElectricLocomotiveViewer : LocomotiveViewer
    {
        ...
        public ElectricLocomotiveViewer(Viewer3D viewer, ElectricLocomotive car)
            : base(viewer, car)
        {
