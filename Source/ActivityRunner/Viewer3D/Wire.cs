    ...
    public class Wire
    {
        ...
        public static int DecomposeStaticWire(Viewer viewer, List<DynamicTrackViewer> trackList, TrackObject trackObj, in WorldPosition worldMatrixInput)
        {
            ...
            foreach (SectionIndex id in SectionIdxs)
            {
                ...
                Matrix4x4 trackRot = Matrix4x4.CreateRotationY(-MathHelper.ToRadians(id.AngularOffset));
                ...
                for (int i = 0; i < sections.Length; i++)
                {
                    ...
                    else
                    {
                        ...
                        Matrix4x4 rot = Matrix4x4.CreateRotationY(-MathHelper.ToRadians(section.Angle)); // Heading change (rotation about O)
