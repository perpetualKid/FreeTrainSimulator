					...
					if (dist > -1)
					{
						...
						else    // Draw the train as 2 boxes of fixed size
						{
							...
							else // car == t.Cars.Last()
							{
								...
								dist = t1.DistanceTo(new WorldLocation(worldPos.WorldLocation.TileX, worldPos.WorldLocation.TileZ, worldPos.WorldLocation.Location.X, worldPos.WorldLocation.Location.Y, worldPos.WorldLocation.Location.Z));
