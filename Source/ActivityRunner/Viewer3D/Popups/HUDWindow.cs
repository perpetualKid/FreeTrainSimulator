...
namespace Orts.ActivityRunner.Viewer3D.Popups
{
    public class HUDWindow : LayeredWindow
    {
        ...
        private void TextPageDebugInfo(TableData table)
        {
            ...
            TableAddLabelValue(table, Viewer.Catalog.GetString("Render process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.Render].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.Render].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
            TableAddLabelValue(table, Viewer.Catalog.GetString("Updater process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.Updater].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.Updater].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
            TableAddLabelValue(table, Viewer.Catalog.GetString("Loader process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.Loader].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.Loader].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
            TableAddLabelValue(table, Viewer.Catalog.GetString("Sound process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.Sound].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.Sound].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
            TableAddLabelValue(table, Viewer.Catalog.GetString("Background process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.System].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.System].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
            TableAddLabelValue(table, Viewer.Catalog.GetString("Total process"), Viewer.Catalog.GetString("{0:F0}% ({1:F0}% {2})", Profiler.ProfilingData[ProcessType.Render].Wall.SmoothedValue + Profiler.ProfilingData[ProcessType.Updater].Wall.SmoothedValue + Profiler.ProfilingData[ProcessType.Loader].Wall.SmoothedValue + Profiler.ProfilingData[ProcessType.Sound].Wall.SmoothedValue + Profiler.ProfilingData[ProcessType.System].Wall.SmoothedValue, Profiler.ProfilingData[ProcessType.Render].Wait.SmoothedValue + Profiler.ProfilingData[ProcessType.Updater].Wait.SmoothedValue + Profiler.ProfilingData[ProcessType.Loader].Wait.SmoothedValue + Profiler.ProfilingData[ProcessType.Sound].Wait.SmoothedValue + Profiler.ProfilingData[ProcessType.System].Wait.SmoothedValue, Viewer.Catalog.GetString("wait")));
