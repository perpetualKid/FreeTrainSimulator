...
namespace Orts.ActivityRunner.Viewer3D.RollingStock
{
    public class MSTSSteamLocomotiveViewer : MSTSLocomotiveViewer
    {
        ...
        private List<ParticleEmitterViewer> CylinderSteamExhaust1 = new List<ParticleEmitterViewer>();
        private List<ParticleEmitterViewer> CylinderSteamExhaust2 = new List<ParticleEmitterViewer>();
        private List<ParticleEmitterViewer> CylinderSteamExhaust3 = new List<ParticleEmitterViewer>();
        private List<ParticleEmitterViewer> CylinderSteamExhaust4 = new List<ParticleEmitterViewer>(); 
            ...
            : base(viewer, car)
        {
            ...
            foreach (KeyValuePair<string, List<ParticleEmitterViewer>> emitter in ParticleDrawers)
            {
                ...
                else if (emitter.Key.Equals("cylindersteamexhaust4fx", StringComparison.OrdinalIgnoreCase))
        ...
        public override void PrepareFrame(RenderFrame frame, in ElapsedTime elapsedTime)
        {
            ...
            foreach (var drawer in Stack)
            {
                ...
                drawer.SetOutput((float)car.StackSteamVelocityMpS.SmoothedValue, car.StackSteamVolumeM3pS, car.StackParticleDurationS, new Color(color_Value, color_Value, color_Value));
            }
