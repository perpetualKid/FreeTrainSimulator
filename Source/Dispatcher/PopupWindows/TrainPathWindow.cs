...
#pragma warning restore CA2213 // Disposable fields should be disposed
        ...
        public TrainPathWindow(WindowManager owner, DispatcherSettings settings, Point relativeLocation, Catalog catalog = null) :
        ...
        {
            base.Initialize();
            if (toolboxSettings.RestoreLastView && EnumExtension.GetValue(toolboxSettings.PopupSettings[DispatcherWindowType.TrainPathWindow], out TabSettings tab))
        ...
        {
            toolboxSettings.PopupSettings[DispatcherWindowType.TrainPathWindow] = e.Tab.ToString();
        }
