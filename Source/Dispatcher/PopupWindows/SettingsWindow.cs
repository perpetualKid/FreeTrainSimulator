...
#pragma warning restore CA2213 // Disposable fields should be disposed
        ...
        public SettingsWindow(WindowManager owner, DispatcherSettings settings, ContentArea contentArea, Point relativeLocation, Catalog catalog = null) :
        ...
        protected override ControlLayout Layout(ControlLayout layout, float headerScaling = 1)
        {
            ...
            tabControl.TabLayouts[TabSettings.Common] = (layoutContainer) =>
            {
                ...
                chkOutlineFont.OnClick += (object sender, MouseClickEventArgs e) =>
                {
                    ...
                    ((Owner as WindowManager<DispatcherWindowType>)[DispatcherWindowType.DebugScreen] as DebugScreen).UpdateBackgroundColor(ColorExtension.FromName(toolboxSettings.ColorSettings[ColorSetting.Background]));
                };
        ...
        {
            toolboxSettings.PopupSettings[DispatcherWindowType.SettingsWindow] = e.Tab.ToString();
        }

        protected override void Initialize()
        {
            base.Initialize();
            if (toolboxSettings.RestoreLastView && EnumExtension.GetValue(toolboxSettings.PopupSettings[DispatcherWindowType.SettingsWindow], out TabSettings tab))
