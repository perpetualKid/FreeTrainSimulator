...
namespace LibAE
{
    ...
    public class PathEventItem : globalItem
    {
        ...
        {
            typeWidget = (int)TypeEvent.ACTIVITY_EVENT;
    ...
    public class ActStartItem : PathEventItem
    {
        ...
        public override void configCoord(MSTSCoord coord)
        {
            ...
            typeWidget = (int)TypeWidget.ACTIVITY_WIDGET;
            nameVisible = false;
        }
    ...
    public class ActStopItem : PathEventItem
    {
            ...
            : base(interfaceType)
        {
            ...
            typeWidget = (int)TypeEvent.ACTIVITY_STOP;
    ...
    public class ActWaitItem : PathEventItem
    {
            ...
            : base(interfaceType)
        {
            ...
            typeWidget = (int)TypeEvent.ACTIVITY_WAIT;
