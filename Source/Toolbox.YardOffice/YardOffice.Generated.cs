/* Generated by MyraPad at 9/4/2022 6:27:27 PM */
using Myra;
...
namespace Toolbox.YardOffice
{
	partial class YardOffice: VerticalStackPanel
	{
		private void BuildUI()
		{
			...
			YOTotalBox.Text = "                           ";
			YOTotalBox.Background = new SolidBrush("#000000FF");
			...
			YO_Panel1 = new VerticalStackPanel();
			YO_Panel1.Proportions.Add(new Proportion
			{
				Type = Myra.Graphics2D.UI.ProportionType.Auto,
			});
			YO_Panel1.Proportions.Add(new Proportion
			...
			YO_Panel1.Id = "YO_Panel1";
			YO_Panel1.Widgets.Add(horizontalStackPanel1);
			YO_Panel1.Widgets.Add(horizontalStackPanel2);
			YO_Panel1.Widgets.Add(horizontalStackPanel3);
			YO_Panel1.Widgets.Add(YOConsistList);
			...
			YO1TotalBox.Text = "                           ";
			YO1TotalBox.Background = new SolidBrush("#000000FF");
			...
			YO1SearchBox.Text = "                           ";
			YO1SearchBox.Background = new SolidBrush("#000000FF");
			...
			YO1numaddBox.Text = "                           ";
			YO1numaddBox.Background = new SolidBrush("#000000FF");
			...
			YOPanel2 = new VerticalStackPanel();
			YOPanel2.Proportions.Add(new Proportion
			{
				Type = Myra.Graphics2D.UI.ProportionType.Auto,
			});
			YOPanel2.Proportions.Add(new Proportion
			...
			YOPanel2.Id = "YOPanel2";
			YOPanel2.Widgets.Add(horizontalStackPanel4);
			YOPanel2.Widgets.Add(horizontalStackPanel5);
			YOPanel2.Widgets.Add(horizontalStackPanel6);
			YOPanel2.Widgets.Add(horizontalStackPanel7);
			YOPanel2.Widgets.Add(horizontalStackPanel8);
			YOPanel2.Widgets.Add(horizontalStackPanel9);
			YOPanel2.Widgets.Add(YO1ConsistList);
			...
			panel2.Background = new SolidBrush("#CF56BFFF");
			...
			horizontalStackPanel10.Background = new SolidBrush("#202020FF");
			horizontalStackPanel10.Widgets.Add(YO_Panel1);
			horizontalStackPanel10.Widgets.Add(YOPanel2);
		...
		public VerticalStackPanel YO_Panel1;
		...
		public VerticalStackPanel YOPanel2;
	}
}
