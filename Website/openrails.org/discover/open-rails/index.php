<?php include "../../shared/head.php" ?>
  ...
  <body>
    <!-- "container" class centres content and sets fixed width to suit device -->
    <div class="container">
...
<p>
  ...
  MSTS, which was launched in 2001, was very successful but Microsoft had several false starts at developing it further 
  and these came to an end in 2009. However, MSTS was an open platform and a host of content both free and commercial has been 
  developed for it.
</p><p>
  Open Rails is a successor to MSTS and runs the trains on routes built for MSTS. However, there are some differences 
  worth discussing.
</p><p>
...
<p>
  Started late in 2009, the project is now reaching a most exciting stage as we achieve the goal of replacing MSTS and move on with plans to do much better
  than MSTS in both realism and facilities such as multi-user, timetables and editors for creating content.
</p>
			</div>
		</div>
