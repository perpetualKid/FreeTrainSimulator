...
$file_path = "$path/../files/setup_OR_pre-v1.0_from_download.exe";
echo date('Y', filemtime($file_path));
?> &nbsp; Open Rails
            </p>
    ...
    <script> // Work-around to use local file if CDN is blocked - see http://stackoverflow.com/questions/5257923/how-to-load-local-script-files-as-fallback-in-cases-where-cdn-are-blocked-unavai
		  if (typeof jQuery == 'undefined'){ 
		    document.write('<script src="/shared/jquery/1.11.0/jquery.min.js">\x3C/script>')
      }
		</script>
    <script src="//netdna.bootstrapcdn.com/bootstrap/3.1.0/js/bootstrap.min.js"></script>
    <script> // Work-around to use local file if CDN is blocked.
